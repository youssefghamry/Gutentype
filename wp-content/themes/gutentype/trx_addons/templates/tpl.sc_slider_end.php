...
$controls = '<div class="slider_controls_wrap">'
				. '<a class="slider_prev swiper-button-prev" href="#"><span class="label-swipe">'.esc_html__( 'Prev slide', 'gutentype' ).'</span></a>'
				. '<a class="slider_next swiper-button-next" href="#"><span class="label-swipe">'.esc_html__( 'Next slide', 'gutentype' ).'</span></a>'
			. '</div>';
