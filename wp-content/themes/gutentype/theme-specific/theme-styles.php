...
.trx_addons_popup_form .trx_addons_popup_form_field input[type="checkbox"] + label:before {
...
#elegro-reset-wrapper .elegro-widget__button.elegro-widget__button--instant:disabled{
    color: {$colors['text_link']}!important;
}
#elegro-reset-wrapper .elegro-widget__button.elegro-widget__button--instant{
    color: {$colors['text_link']};
    border-color: {$colors['text_link']};
...
#elegro-reset-wrapper .elegro-widget__button.elegro-widget__button--instant:hover,
