...
.sc_blogger.sc_blogger_default_divided .footer_copyright_wrap  .copyright_text{
...
.sc_blogger_default_divided .sc_blogger_item{
	background-color: {$colors['bg_color']};
}
.sc_blogger_default_divided  .sc_blogger_item_header,
.sc_blogger.sc_blogger_default_divided .comments_form_wrap{
	background-color: {$colors['alter_bg_color']};
}
...
/* Blogger divided */
.sc_blogger_default_divided .post_featured .mask{
	background-color: {$colors['extra_bg_color']};
}
.sc_blogger_default_divided .sc_blogger_item_title a,
.sc_blogger_default_divided .post_featured .author_wrapper .post_meta_item{
	color: {$colors['inverse_link']};
}
.sc_blogger_default_divided .sc_blogger_item_title a:hover,
.sc_blogger_default_divided .post_featured .author_wrapper a.post_meta_item:hover{
	color: {$colors['text_link']};
}
