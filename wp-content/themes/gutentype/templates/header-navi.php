...
">
	<div class="content_wrap">
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid <?php echo gutentype_exists_trx_addons() ? 'column-8_12' : 'column-3_12'?>">
				...
				if(!gutentype_exists_trx_addons()) { ?></div><div class="no_trx_addons sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-9_12"><?php }
			...
			if(gutentype_exists_trx_addons()) {
				?><div class="sc_layouts_column sc_layouts_column_align_right sc_layouts_column_icons_position_left sc_layouts_column_fluid column-4_12">
